...
|  [X]  |  6  | Vòng lặp `Thread.sleep()` chặn worker thread      | ⚡ Bottleneck          |   **HIGH**   | `ResumeUploadServiceImpl.java`                      |
|  [X]  |  7  | `RateLimitFilter` gọi Redis lặp lại nhiều lần     | ⚡ Bottleneck          |   **HIGH**   | `RateLimitFilter.java`, `RateLimitServiceImpl.java` |
