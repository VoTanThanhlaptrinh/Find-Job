...
export const TRANSLATIONS: Record<AppLanguage, TranslationTree> = {
  vi: {
    ...
    recruiterDashboard: {
      ...
      logout: 'Đăng xuất',
      welcome: 'Kh?ng gian l?m vi?c',
      greeting: 'Ch?o bu?i s?ng',
      loadingSummary: '?ang t?i t?ng quan tuy?n d?ng c?a b?n.',
      unavailableSummary: 'Kh?ng th? t?i s? li?u t?ng quan l?c n?y.',
      jobsManaged: 'tin tuy?n d?ng ?ang ???c qu?n l?.',
      manageJobs: 'Qu?n l? tin tuy?n d?ng',
      totalJobs: 'T?ng tin ?? ??ng',
      totalJobsHint: 'Xem to?n b? tin tuy?n d?ng c?a b?n.',
      applicationsInView: 'L??t ?ng tuy?n',
      withoutApplicants: 'Tin ch?a c? ?ng vi?n',
      needsAnalysis: 'Tin ch?a ph?n t?ch AI',
      visibleJobsHint: 'D?a tr?n danh s?ch tin ?ang hi?n th?.',
      priorityJobs: 'Tin tuy?n d?ng c?n ch? ?',
      priorityJobsDescription: '?u ti?n c?c tin ch?a c? ?ng vi?n ho?c ch?a ???c ph?n t?ch AI.',
      applicants: '?ng vi?n',
      headcount: 'ch? ti?u',
      noApplicants: 'Ch?a c? ?ng vi?n',
      analysisReady: '?? ph?n t?ch AI',
      analysisNeeded: 'C?n ph?n t?ch AI',
      viewCandidates: 'Xem ?ng vi?n',
      viewDetails: 'Xem chi ti?t',
      analyze: 'Ph?n t?ch AI',
      emptyTitle: 'B?n ch?a c? tin tuy?n d?ng n?o',
      emptyDescription: '??ng tin ??u ti?n ?? b?t ??u ti?p c?n ?ng vi?n.',
      errorTitle: 'Kh?ng th? t?i t?ng quan',
      errorDescription: 'Vui l?ng th? l?i sau ?t ph?t.',
      retry: 'Th? l?i',
      quickActions: 'Thao t?c nhanh',
      quickActionsDescription: 'C?c c?ng vi?c th??ng d?ng ?? qu?n l? tuy?n d?ng.',
      postJobDescription: 'T?o m?t v? tr? tuy?n d?ng m?i.',
      manageJobsDescription: 'Theo d?i v? c?p nh?t c?c tin ?? ??ng.',
      companyAddress: '??a ch? c?ng ty',
      companyAddressDescription: 'Qu?n l? c?c ??a ?i?m l?m vi?c.',
    },
    recruiterOverview: {
      title: 'Tổng quan',
