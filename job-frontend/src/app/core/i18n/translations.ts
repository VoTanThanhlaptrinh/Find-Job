...
export const TRANSLATIONS: Record<AppLanguage, TranslationTree> = {
  vi: {
    ...
    recruiterDashboard: {
      ...
      logout: 'Đăng xuất',
      welcome: 'Không gian làm việc',
      greeting: 'Chào buổi sáng',
      loadingSummary: 'Đang tải tổng quan tuyển dụng của bạn.',
      unavailableSummary: 'Không thể tải số liệu tổng quan lúc này.',
      jobsManaged: 'tin tuyển dụng đang được quản lý.',
      manageJobs: 'Quản lý tin tuyển dụng',
      totalJobs: 'Tổng tin đã đăng',
      totalJobsHint: 'Xem toàn bộ tin tuyển dụng của bạn.',
      applicationsInView: 'Lượt ứng tuyển',
      withoutApplicants: 'Tin chưa có ứng viên',
      needsAnalysis: 'Tin chưa phân tích AI',
      visibleJobsHint: 'Dựa trên danh sách tin đang hiển thị.',
      priorityJobs: 'Tin tuyển dụng cần chú ý',
      priorityJobsDescription: 'Ưu tiên các tin chưa có ứng viên hoặc chưa được phân tích AI.',
      applicants: 'ứng viên',
      headcount: 'chỉ tiêu',
      noApplicants: 'Chưa có ứng viên',
      analysisReady: 'Đã phân tích AI',
      analysisNeeded: 'Cần phân tích AI',
      viewCandidates: 'Xem ứng viên',
      viewDetails: 'Xem chi tiết',
      analyze: 'Phân tích AI',
      emptyTitle: 'Bạn chưa có tin tuyển dụng nào',
      emptyDescription: 'Đăng tin đầu tiên để bắt đầu tiếp cận ứng viên.',
      errorTitle: 'Không thể tải tổng quan',
      errorDescription: 'Vui lòng thử lại sau ít phút.',
      retry: 'Thử lại',
      quickActions: 'Thao tác nhanh',
      quickActionsDescription: 'Các công việc thường dùng để quản lý tuyển dụng.',
      postJobDescription: 'Tạo một vị trí tuyển dụng mới.',
      manageJobsDescription: 'Theo dõi và cập nhật các tin đã đăng.',
      companyAddress: 'Địa chỉ công ty',
      companyAddressDescription: 'Quản lý các địa điểm làm việc.',
    },
    recruiterOverview: {
      title: 'Tổng quan',
    ...
    recruiterPostJob: {
      ...
      categoryPlaceholder: 'Nhập để tìm danh mục...',
      salary: 'Mức lương',
      ...
      profileDetails: 'Chi tiết tin tuyển dụng',
      description: 'Mô tả công việc',
      descriptionPlaceholder: 'Mô tả các trách nhiệm chính của vị trí này...',
      skills: 'Kỹ năng chuyên môn',
      skillsPlaceholder: 'Ví dụ: Java, Spring Boot, React, Figma...',
      ...
      aiAnalysisSubtitle: 'Gợi ý & chấm điểm CV tự động',
      aiAnalysisToggle: 'Phân tích JD bằng AI',
      aiAnalysisDesc: 'Bật để AI phân tích JD cho gợi ý semantic search',
      categoryEmpty: 'Không tìm thấy danh mục',
      validation: {
        required: 'Trường này không được để trống',
        jobNameRequired: 'Tên công việc không được để trống',
        jobNameMax: 'Tên công việc tối đa 255 ký tự',
        categoryRequired: 'Vui lòng chọn danh mục công việc',
        jobTypeRequired: 'Vui lòng chọn loại hình công việc',
        locationRequired: 'Vui lòng chọn địa điểm làm việc',
        salaryRequired: 'Mức lương không được để trống',
        salaryMax: 'Mức lương tối đa 255 ký tự',
        headcountRequired: 'Số lượng tuyển dụng không được để trống',
        headcountMin: 'Số lượng tuyển dụng phải ít nhất là 1',
        deadlineRequired: 'Hạn nộp hồ sơ không được để trống',
        deadlineFuture: 'Hạn nộp CV phải sau ít nhất một ngày so với hôm nay',
        descriptionRequired: 'Mô tả công việc không được để trống',
        descriptionMax: 'Mô tả công việc tối đa 5.000 ký tự',
        skillsRequired: 'Yêu cầu kỹ năng không được để trống',
        skillsMax: 'Kỹ năng chuyên môn tối đa 5.000 ký tự',
        requirementsRequired: 'Yêu cầu công việc không được để trống',
        requirementsMax: 'Yêu cầu ứng viên tối đa 5.000 ký tự',
  ...
  en: {
    ...
    recruiterDashboard: {
      ...
      loadingSummary: 'Loading your recruitment overview.',
      unavailableSummary: 'Your dashboard data is unavailable right now.',
      jobsManaged: 'job posts are being managed.',
      manageJobs: 'Manage job posts',
      totalJobs: 'Total job posts',
      totalJobsHint: 'View all of your posted jobs.',
      applicationsInView: 'Applications',
      withoutApplicants: 'Jobs without applicants',
      needsAnalysis: 'Jobs needing AI analysis',
      visibleJobsHint: 'Based on the job posts currently shown.',
      priorityJobs: 'Job posts needing attention',
      priorityJobsDescription: 'Prioritized when they have no applicants or still need AI analysis.',
      applicants: 'applicants',
      headcount: 'headcount',
      noApplicants: 'No applicants yet',
      analysisReady: 'AI analysis complete',
      analysisNeeded: 'AI analysis needed',
      viewCandidates: 'View candidates',
      viewDetails: 'View details',
      analyze: 'Analyze with AI',
      emptyTitle: 'You have not posted any jobs yet',
      emptyDescription: 'Post your first job to start reaching candidates.',
      errorTitle: 'Unable to load your overview',
      errorDescription: 'Please try again in a moment.',
      retry: 'Try again',
      quickActions: 'Quick actions',
      quickActionsDescription: 'Frequently used actions for managing recruitment.',
      postJobDescription: 'Create a new job post.',
      manageJobsDescription: 'Review and update your posted jobs.',
      companyAddress: 'Company addresses',
      companyAddressDescription: 'Manage your work locations.',
    },
    recruiterOverview: {
      title: 'Overview',
    ...
    recruiterPostJob: {
      ...
      skillsPlaceholder: 'e.g. Java, Spring Boot, React, Figma...',
      ...
      aiAnalysisSubtitle: 'Auto CV scoring & matching insights',
      ...
      validation: {
        ...
        jobNameRequired: 'Job title is required',
        jobNameMax: 'Job title cannot exceed 255 characters',
        categoryRequired: 'Please select a job category',
        jobTypeRequired: 'Please select an employment type',
        locationRequired: 'Please select a work location',
        salaryRequired: 'Salary is required',
        salaryMax: 'Salary cannot exceed 255 characters',
        headcountRequired: 'Headcount is required',
        headcountMin: 'Headcount must be at least 1',
        deadlineRequired: 'Application deadline is required',
        deadlineFuture: 'Application deadline must be at least one day in the future',
        descriptionRequired: 'Job description is required',
        descriptionMax: 'Job description cannot exceed 5,000 characters',
        skillsRequired: 'Required skills are required',
        skillsMax: 'Required skills cannot exceed 5,000 characters',
        requirementsRequired: 'Job requirements are required',
        requirementsMax: 'Job requirements cannot exceed 5,000 characters',
