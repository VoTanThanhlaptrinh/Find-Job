...
export class CategorySectionComponent implements AfterViewInit, OnDestroy {
  ...
  roles: CareerRole[] = [
    {
      id: 'developer',
      titleKey: 'home.categorySection.roles.developer',
      icon: 'terminal',
    ...
    {
      id: 'expert',
      titleKey: 'home.categorySection.roles.expert',
      icon: 'psychology',
    ...
    {
      id: 'engineer',
      titleKey: 'home.categorySection.roles.engineer',
      icon: 'engineering',
    ...
    {
      id: 'manager',
      titleKey: 'home.categorySection.roles.manager',
      icon: 'badge',
  ...
  badges: FloatingCategoryBadge[] = [
    {
      id: 1,
      slug: 'code',
      titleKey: 'home.categorySection.badges.code',
      icon: 'code',
    ...
    },
    {
      id: 2,
      slug: 'eng',
      titleKey: 'home.categorySection.badges.eng',
      icon: 'settings',
    ...
    },
    {
      id: 3,
      slug: 'media',
      titleKey: 'home.categorySection.badges.media',
      icon: 'campaign',
    ...
    },
    {
      id: 4,
      slug: 'accounting',
      titleKey: 'home.categorySection.badges.accounting',
      icon: 'calculate',
    ...
    },
    {
      id: 5,
      slug: 'consulting',
      titleKey: 'home.categorySection.badges.consulting',
      icon: 'support_agent',
    ...
    },
    {
      id: 6,
      slug: 'mgmt',
      titleKey: 'home.categorySection.badges.mgmt',
      icon: 'trending_up',
