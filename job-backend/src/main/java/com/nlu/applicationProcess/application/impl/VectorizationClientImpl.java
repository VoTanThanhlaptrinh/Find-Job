...
@Slf4j
@Service
public class VectorizationClientImpl implements VectorizationClient {
    ...
    public VectorizationClientImpl(RestClient.Builder restClientBuilder, @Value("${application.ai.agent.base-url}") String baseUrl) {
