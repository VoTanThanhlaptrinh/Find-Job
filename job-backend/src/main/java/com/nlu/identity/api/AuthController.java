...
public class AuthController {
    ...
    public CompletableFuture<ResponseEntity<ApiResponse<String>>> sendActivationLink(@PathVariable String email) {
        ...
        return CompletableFuture.completedFuture(ResponseEntity
                .ok(new ApiResponse<>(MessageUtils.getMessage("auth.email.sent"), null, HttpStatus.OK.value())));
    }
    ...
    public ResponseEntity<ApiResponse<String>> activateAccount(@PathVariable String token) {
        ...
        return ResponseEntity
                .ok(new ApiResponse<>(MessageUtils.getMessage("auth.activate.success"), null, HttpStatus.OK.value()));
    }
    ...
    public ResponseEntity<ApiResponse<String>> refreshToken(HttpServletRequest request, HttpServletResponse response) {
        ...
        return ResponseEntity
                .ok(new ApiResponse<>(MessageUtils.getMessage("message.success"), accessToken, HttpStatus.OK.value()));
    }
    ...
    public ResponseEntity<ApiResponse<String>> logout(HttpServletRequest request, HttpServletResponse response) {
        ...
        return ResponseEntity
                .ok(new ApiResponse<>(MessageUtils.getMessage("auth.logout.success"), null, HttpStatus.OK.value()));
    }
    ...
    public ResponseEntity<ApiResponse<String>> googleUrl(HttpServletRequest req) {
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(new ApiResponse<>(MessageUtils.getMessage("message.success"), url, HttpStatus.OK.value()));
    }

    // @GetMapping("/status")
    // public ResponseEntity<ApiResponse<String>> checkLogin(@CurrentUser User
    // currentUser) {
    // String name = authService.checkLogin(currentUser);
    // return ResponseEntity.ok(new
    // ApiResponse<>(MessageUtils.getMessage("message.success"), name,
    // HttpStatus.OK.value()));
    // }
    ...
    public ResponseEntity<ApiResponse<String>> sendForgotPasswordCode(@PathVariable String email,
        ...
        return ResponseEntity
                .ok(new ApiResponse<>(MessageUtils.getMessage("auth.password.code_sent"), null, HttpStatus.OK.value()));
    }
    ...
    public ResponseEntity<ApiResponse<String>> forgotPassword(@RequestBody @Valid ForgotPassDTO forgotPassDTO) {
        ...
        return ResponseEntity
                .ok(new ApiResponse<>(MessageUtils.getMessage("message.success"), random, HttpStatus.OK.value()));
    }
    ...
    public ResponseEntity<ApiResponse<String>> checkRandom(@PathVariable String random) {
        ...
        return ResponseEntity
                .ok(new ApiResponse<>(MessageUtils.getMessage("message.success"), null, HttpStatus.OK.value()));
    }
