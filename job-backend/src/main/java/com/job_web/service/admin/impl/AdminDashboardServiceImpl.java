...
import com.job_web.service.admin.AdminDashboardService;
...
public class AdminDashboardServiceImpl implements AdminDashboardService {
    ...
    public DashboardSummaryResponse getDashboardSummary() {
        return DashboardSummaryResponse.builder()
                .totalEmployers(hirerRepository.count())
        ...
        return PageResponse.<PendingJobItem>builder()
                .items(jobs.getContent().stream()
                        .map(job -> PendingJobItem.builder()
                                ...
                                .company(job.getHirer() != null ? job.getHirer().getCompanyName() : "Unknown")
