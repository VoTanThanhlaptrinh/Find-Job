...
import com.job_web.application_process.application.impl.JobApplicationServiceImpl;
...
class JobApplicationServiceImplTest {
    ...
    class JobApplicationWithUploadCvTests {
        ...
        void applyWithUploadCv_Success_WithDetachedUser() throws IOException {
            ...
            detachedUser.setEmail(new EmailAddress("user@test.com"));

            User managedUser = new User();
            managedUser.setId(7L);
            managedUser.setEmail(new EmailAddress("user@test.com"));
            ...
            ArgumentCaptor<JobApplication> applyCaptor = ArgumentCaptor.forClass(JobApplication.class);
            verify(jobApplicationRepository).save(applyCaptor.capture());
    ...
    class JobApplicationWithExistingCvTests {
